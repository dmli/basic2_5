 ...
 */
public class LImageOverView extends ImageView {
    ...
    public LImageOverView(Context context) {
        super(context);
        init();
    }

    public LImageOverView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LImageOverView(Context context, AttributeSet attrs, int defStyle) {
