...
/**
 * Created by ldm on 13-5-22.
 * <p/>
 * 快速滑动view(eoe中网友编写)
 * <p/>
 * fastSlideView = (LFastSlideView) getView(R.id.fastSlideView);
 * fastSlideView.setTheme(Color.parseColor("#39414C"), getResources().getDimensionPixelSize(R.dimen.ah5), Color.argb(0, 0, 0, 0), Color.parseColor("#99dee9f9"));
 * fastSlideView.setFirstCharBitmap(BitmapHelper.createBitmapToResources(getResources(), R.drawable.contacts_magnifier_character_ic));
 * fastSlideView.setOnTouchingLetterChangedListener(this);
 */
public class LFastSlideView extends View {
    ...
    private void touch(MotionEvent event, OnTouchingLetterChangedListener listener) {
