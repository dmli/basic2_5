...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = SystemTool.dipToPx(5);
    private static final float Y = SystemTool.dipToPx(20);
    private static final float V = SystemTool.dipToPx(2);
    private static final float W = SystemTool.dipToPx(1);
